...
/* Brand icons not in lucide (X / Pinterest) */
  ...
  return (
    <footer className="bg-black text-white pt-10 pb-6 relative">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-11 h-11 rounded-md flex items-center justify-center text-black shadow-lg hover:brightness-110"
        style={{ background: GOLD }}
      >
        <ChevronUp size={20} />
      </button>
